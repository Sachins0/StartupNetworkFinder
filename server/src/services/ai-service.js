...
const findMatch = async (query, networkMembers) => {
    try {
        ...
        Please analyze the query and find the most suitable investor or mentor from the list.Return only the name of the most suitable person.
        If no suitable person is found, return "No match found Try again later".`;
